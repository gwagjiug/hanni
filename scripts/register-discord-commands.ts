...
const required = ["DISCORD_APPLICATION_ID", "DISCORD_BOT_TOKEN", "DISCORD_GUILD_ID"] as const;
...
const commands = [
  {
    ...
    options: [
      { name: "url", description: "보관할 공개 http/https URL", type: 3, required: true },
      { name: "pin", description: "첫 번째로 보관할 문장", type: 3, required: true, max_length: 2000 },
  ...
  { name: "hanni-cost", description: "이번 달 Hanni 토큰과 예상 비용을 확인합니다" },
