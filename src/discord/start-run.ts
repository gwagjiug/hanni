import { analyzeArchiveUrl, createArchiveWorkflowDependencies } from "../skills/archive-url/run";
import { RunStore } from "../storage/runs";
import { DiscordClient } from "../tools/discord";
import type { Env } from "../types";
import { interactionUserId, normalizedUrlHash, type DiscordInteraction } from "./interaction";
